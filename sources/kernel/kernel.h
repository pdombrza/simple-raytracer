...
__global__ void createWorld(Hittable** d_List, HittableList* d_World, glm::vec3* vertexArray, int* indexArray, MeshDescriptor* descriptors, int meshCount, Mesh* d_meshes, int numObjects);
